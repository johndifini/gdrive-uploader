...
## Security Info
If you are concerned about running some strange code that will access to your Google Drive, **good for you**!  I had a similar concern, which led me to develop this simple utility script (see Alternative).  The first part of the code is nearly verbatim from Google's official [Quickstart documentation](https://developers.google.com/drive/api/v3/quickstart/nodejs#step_3_set_up_the_sample), but I made it more secure by putting the credentials.json and token.json in the home dir.
