...
The last part of the code is also nearly verbatim from Google's official [Perform a simple upload](https://developers.google.com/drive/api/v3/manage-uploads#simple) example, but I made it more flexible by using a configuration file.  I also fixed a bug (file.id should be file.data.id).
## Alternative
